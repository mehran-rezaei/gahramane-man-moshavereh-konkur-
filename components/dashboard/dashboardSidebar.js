          ...
          >
            ...
            <div className='pb-20 '>
                    <ul className='text-white'>
                        ...
                        <Link href='/student' className={page.redirecter ? "focus:text-navbarBt focus:hover:text-navbarBt focus:bg-white flex a2" : "flex a2"} onClick={() => setPage({type : 'SET-REDIRECT' })} >
                            <img src="./images/dashboard.svg"  className='ml-4 mb-1' alt="" />
                            <span>داشبورد</span>
                        </Link>
                        <Link href='/student'  className={page.userinfo ? "text-navbarBt hover:text-navbarBt bg-white flex a2" : "flex a2"} onClick={() => setPage({type : 'SET-INFO' })}>
                        ...
                        <Link href='/student' className={page.dailiReport ? "text-navbarBt hover:text-navbarBt bg-white flex a2" : "flex a2"}   onClick={() => setPage({type : 'SET-DAILI-REPORT' })}>
                        <img src="./images/dashboard.svg" alt=""  className='ml-4 mb-1'/>
                            <span>گزارش روزانه</span>
                        </Link>
                        <Link href='/student' className={page.dailiHabit ? "text-navbarBt hover:text-navbarBt bg-white flex a2" : "flex a2"}   onClick={() => setPage({type : 'SET-DAILI-HABIT' })}>
                        <img src="./images/dashboard.svg" alt="" className='ml-4 mb-1' />
                            <span>ثبت عادت های روزانه</span>
                        </Link>
                        <Link href='/student'  className={page.redirecter ? "focus:text-navbarBt focus:hover:text-navbarBt focus:bg-white flex a2" : "flex a2"} onClick={() => setPage({type : 'SET-REDIRECT' })}>
                        <img src="./images/dashboard.svg" alt=""  className='ml-4 mb-1'/>
